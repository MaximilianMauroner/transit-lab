...
import { all, one, parseJson } from "../database/db.js";
 ...
 */
export async function loadSimilarityResult({ db, root, querySnapshotId, candidateSnapshotId, queryLineId, queryLineIndex, profile }) {
